<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl flex justify-between items-center text-gray-800 leading-tight">
            {{ __('Task Edit') }}
            <a href="{{ route('tasks.index') }}" class="float-right bg-[#2A3F54] text-[#fff] px-4 py-2 rounded-md font-normal text-sm">Back</a>
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <div class="flex space-x-5">
                            ...
                            <textarea name="description" class="block mt-1 w-full rounded-md border-gray-300" id="description">{{ old('description', $task->description) }}</textarea>
                        ...
                        <div class="flex space-x-5 mt-5">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="deadline_at" class="block mt-1 w-full" type="date" name="deadline_at" :value="old('deadline_at', $task->deadline_at)" required autocomplete="username" />
                        ...
                        <div class="w-[49%] mt-5">
                            <x-input-label for="project_id" :value="__('Project Status')" />
                            <select name="project_id" id="project_id" class="block w-full rounded-md border-gray-300">
