                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="flex space-x-5">
                            ...
                            <textarea name="description" class="block mt-1 w-full rounded-md border-gray-300" id="description">{{ old('description') }}</textarea>
                        ...
                        <div class="flex space-x-5 mt-5">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="deadline_at" class="block mt-1 w-full" type="date" name="deadline_at" :value="old('deadline_at')" required autocomplete="username" />
